...
const gallery = ["lapangan-futsal.png", "futsal-1.png", "futsal-2.png"];
    ...
    <div>
      <main className="flex-grow py-30">
        <div className="container mx-auto max-w-6xl px-4 grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            <h2 className="text-3xl font-semibold mb-4">Lapangan Futsal</h2>
            <img
          ...
          <div>
            <p className="text-gray-700 mb-6 leading-relaxed text-justify">
              ...
              reservasi lapangan. Pastikan waktu yang kamu pilih belum
              digunakan oleh pengguna lain agar proses reservasi berhasil.
            </p>
